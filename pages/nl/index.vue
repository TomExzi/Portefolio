...
// SEO optimization for Dutch
useHead({
  title: "Software Engineering & AI Oplossingen - Tom Rogiers",
  meta: [
    {
      name: "description",
      content:
        "Expert software engineering en AI oplossingen door Tom Rogiers. Gespecialiseerd in AI integratie, machine learning en enterprise software oplossingen.",
    },
    {
      property: "og:title",
      content: "Software Engineering & AI Oplossingen - Tom Rogiers",
    },
    {
      property: "og:description",
      content:
        "Expert AI oplossingen met aangepaste ontwikkeling, NLP, document automatisering en voorspellende analyses.",
    },
  ...
  link: [{ rel: "canonical", href: "https://tomRogiers.com/nl" }],
});
      ...
      >
        <div class="max-w-4xl mx-auto text-center space-y-6">
          <div class="relative">
            ...
            >
              {{
                $t("ai.heroTitle", "Uw Bedrijf Versterken met AI Oplossingen")
              }}
            </h1>
          </div>
          ...
          <div class="relative">
            ...
            >
              {{
                $t(
                  "ai.heroDescription",
                  "Schaalbare, innovatieve oplossingen bouwen met moderne technologieën. Gespecialiseerd in AI-integratie, webontwikkeling en bedrijfssoftware."
                )
              }}
            </p>
          </div>
          <div class="flex flex-wrap justify-center gap-4 pt-4">
            ...
            >
              <span>{{ $t("ai.getStarted", "Beginnen") }}</span>
            ...
            >
              <span>{{
                $t("projects.viewProjects", "Projecten bekijken")
              }}</span>
              <Icon name="heroicons:arrow-right" class="w-5 h-5" />
            </button>
          </div>
